...
class ChainOfResponsibilityDemo {
    ...
    static RequestHandler commonRequestHandler = request -> {
        return wrapInRequestTag.handle(createDigest.combine(request, wrapInTransactionTag));
    };
    ...
    interface RequestHandler {
        ...
        default Request combine(Request req, RequestHandler handler) {
            return this.handle(handler.handle(req));
        }
